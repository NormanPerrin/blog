...
<header>
  ...
  <p>Your comment will be later review and approved by the <em>webmaster</em>.</p>
</header>

<main>
  <p>Know that the message will be publicly visible, at least that you specify it's private, and won't appear until it's reviewed.</p>
  <p>You can add a firm at the bottom of the message to identify if you want.</p>
  <p><i>${subject}</i></p>
  <form method="post">
